...
const talentPrograms: TalentProgram[] = [
  // 互联网大厂
  {
    id: 1,
    company: '字节跳动',
    programName: 'Top Seed 大模型顶尖人才计划',
    description: '字节跳动Seed面向高校优秀人才推出的专项计划，研究课题包括大语言模型、机器学习算法和系统、多模态生成、多模态理解、语音智能等方向。',
    link: 'https://seed.bytedance.com/zh/seedearlycareer',
    category: '互联网大厂',
    tags: ['大模型', '多模态', '校招', '博士优先'],
    salary: '极具竞争力的薪酬',
    targetGroup: '2026/2027届应届博士/硕士'
  },
  {
    id: 2,
    company: '字节跳动',
    programName: 'Seed 大模型人才校招',
    description: '字节跳动Seed面向高校人才推出的招聘项目，岗位包括基础大模型、机器学习系统、视觉智能、语音智能、大模型AI搜索、模型个性化、具身智能等。',
    link: 'https://seed.bytedance.com/zh/career',
    category: '互联网大厂',
    tags: ['大模型', '校招', '实习', '全方向'],
    salary: '高薪',
    targetGroup: '2027届应届生及在校实习生'
  },
  {
    id: 3,
    company: '字节跳动',
  ...
  },
  {
    ...
    description: '阿里巴巴面向全球顶尖青年科研人才推出的招募培养计划，聚焦大语言模型、多模态理解与生成、模型应用、AI Infra等方向。',
  ...
  },
  {
    id: 5,
    company: '阿里云',
    programName: 'A Star Program（全球人才招募项目）',
  ...
  },
  {
    ...
    company: '腾讯',
    programName: '青云计划',
    description: '腾讯面向全球顶尖技术学子的人才专项，提供定制化培养方案、核心业务工作机会、前瞻性技术课题和极具竞争力的薪酬，由张正友、单瀛、胡瀚等杰出科学家担任导师。',
    link: 'https://join.qq.com/qingyun.html',
    category: '互联网大厂',
    tags: ['顶尖技术', '科学家导师', '校招', '高薪'],
    salary: '极具竞争力的薪酬',
  ...
  },
  {
    ...
    company: '百度',
    programName: 'AIDU 计划',
    description: '百度于2018年启动的顶尖AI人才招聘计划，面向全球招募具备顶尖技术潜力的校园人才，致力于培养未来AI领军人才。2026年岗位招聘扩增超60%，覆盖23个核心业务和11类研究方向。薪酬上不封顶。',
    link: 'https://talent.baidu.com/external/baidu/campus.html',
    category: '互联网大厂',
    tags: ['AI领军', '文心大模型', '薪酬无上限', '校招'],
    salary: '上不封顶',
  ...
  },
  {
    ...
    company: '美团',
    programName: '北斗计划',
    description: '美团面向大模型、自动驾驶等前沿技术方向的人才专项计划，全年持续开放，重点聚焦大模型基座及自动驾驶技术。',
    link: 'https://campus.meituan.com/beidou',
    category: '互联网大厂',
    tags: ['大模型', '自动驾驶', '全年开放', '校招'],
  ...
  },
  {
    ...
    description: '美团大模型方向专项校招计划，聚焦大模型研发与应用。',
  ...
  },
  {
    id: 12,
    company: '蚂蚁集团',
    programName: '蚂蚁集团校园招聘（AI方向）',
    description: '蚂蚁集团技术类岗位占比超80%，开放AI算法、大模型、风控等方向，覆盖技术、产品、运营等多类岗位。',
  ...
  },
  {
    ...
    description: '京东面向顶尖技术人才的专项招聘计划，聚焦AI、大模型等前沿技术方向。',
  ...
  },
  {
    id: 14,
    company: '小米',
    programName: '小米校园招聘（AI大模型方向）',
    description: '小米面向应届毕业生开放AI大模型、软硬件、汽车、供应链等全方向岗位。',
  ...
  },
  {
    ...
    company: '网易',
    programName: '网易校园招聘',
    description: '网易面向全球高校应届生的招聘计划，涵盖技术、产品、设计等方向，含星火计划管培生等项目。',
  ...
  // AI独角兽
  {
    ...
    programName: 'DeepSeek 大规模招聘',
    description: 'DeepSeek史上最大规模招聘，开放33个岗位，涵盖算法、系统研发、运维、产品、数据策略、深度学习研究员等7大类方向。包括服务端开发工程师、Agent弹性计算研发、深度学习研发等。',
  ...
  },
  {
    ...
    programName: '月之暗面全球人才招募',
    description: '月之暗面（Kimi）全面开启全球人才招募，包含社招、校招（2027届+2028届）和实习岗位，覆盖产品、技术、算法、运营等方向。',
    link: 'https://careers.kimi.com/',
    category: 'AI独角兽',
    tags: ['AGI', '大模型', '全球招募', '校招'],
  ...
  },
  {
    ...
    programName: '智谱AI招聘',
    description: '智谱AI开放算法/研发、销售、产品经理等多类岗位，涵盖大模型相关产品及应用在各个领域的开拓。',
  ...
  },
  {
    ...
    company: '智谱AI（Zhipu AI）',
    programName: '智谱AI校招',
    description: '智谱AI校园招聘，面向应届毕业生开放算法、工程、产品、解决方案等岗位。',
    link: 'https://zhipu-ai.jobs.feishu.cn/zhipucampus/position/',
    category: 'AI独角兽',
    tags: ['校招', '大模型', '算法'],
    targetGroup: '应届毕业生'
  },
  {
    ...
    description: '阶跃星辰面向全球顶尖技术人才发起的招聘计划，涵盖应届校招及实习，旨在提前吸引和长期培养致力于投身大模型行业的技术人才。',
  ...
  },
  {
    ...
    programName: '百川智能招聘',
    description: '百川智能致力于构建中国最优秀的大模型底座，招聘算法、工程、产品等方向人才。',
  ...
  },
  {
    id: 22,
    company: 'MiniMax',
    programName: 'MiniMax 招聘',
    description: 'MiniMax（大模型六小龙之一）面向AI算法、工程、产品等方向招聘人才。',
  ...
  // 硬件/终端厂商
  {
    ...
    company: '华为',
    programName: '天才少年计划',
    description: '华为面向全球招募顶尖技术天才，聚焦AI大模型在昇腾算力底座的训练推理性能等前沿方向，提供极具竞争力的薪酬。',
  ...
  },
  {
    ...
    description: 'OPPO O-Star顶尖人才计划AI人才专项，聚焦大模型研究、多模态理解与生成、AI Agent、个性化服务算法等领域。',
  ...
  },
  {
    ...
    company: 'vivo',
    programName: '蓝极星计划',
    description: 'vivo面向全球高校顶尖人才（博士）发起的招聘专项，扩招AI、大模型、影像、具身智能等方向人才。',
  ...
  },
  {
    ...
    programName: '商汤科技招聘',
    description: '商汤科技打造专业的深度学习平台及算法模型体系，招聘AI算法、深度学习、智能内容生成等方向人才。',
    link: 'https://www.sensetime.com/cn/join-us',
    category: '硬件/终端厂商',
    tags: ['深度学习', 'AI', '计算机视觉', '大模型'],
    targetGroup: '社招/校招'
  },
  // 其他
  {
    ...
    company: '科大讯飞',
    programName: '飞星计划',
    description: '科大讯飞研究院针对国内外顶尖高校应届硕博毕业生的招聘专项，全链路参与星火大模型研发，挑战顶级AI技术课题。涵盖语音大模型、多模态大模型、认知大模型等方向。',
...
const categories = ['全部', '互联网大厂', 'AI独角兽', '硬件/终端厂商', '其他'];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              汇集国内所有主要大模型AI人才计划与招聘信息，涵盖互联网大厂、AI独角兽、硬件厂商等
              <span className="text-purple-300 font-semibold"> {talentPrograms.length}+ </span>
              个人才计划
            </p>
            <div className="flex flex-wrap justify-center gap-3 text-sm text-gray-400">
              <span className="flex items-center gap-1">
                <i className="fas fa-building text-purple-400"></i> 互联网大厂
              </span>
              <span className="flex items-center gap-1">
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                <span className={`text-xs font-medium px-3 py-1 rounded-full ${
                  program.category === '互联网大厂' ? 'bg-blue-500/10 text-blue-300 border border-blue-500/20' :
                  program.category === 'AI独角兽' ? 'bg-pink-500/10 text-pink-300 border border-pink-500/20' :
                  program.category === '硬件/终端厂商' ? 'bg-orange-500/10 text-orange-300 border border-orange-500/20' :
                  'bg-green-500/10 text-green-300 border border-green-500/20'
                }`}>
                  {program.category}
                </span>
                {program.salary && (
                  <span className="text-xs font-medium px-3 py-1 rounded-full bg-yellow-500/10 text-yellow-300 border border-yellow-500/20">
                    💰 {program.salary}
                  </span>
                )}
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-gray-500 text-xs">
              信息来源于各公司官方招聘网站及公开报道，具体招聘信息请以各公司官网为准 | 最后更新：2026年
            </p>
